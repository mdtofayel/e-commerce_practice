...
public class CustomerController {
	...
	public String viewCutomer(@PathVariable("id") Integer id,
	...
	public String editCustomer(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) {
		try {
			Customer customer = service.get(id);
			List<Country> countries = service.listAllCountres();
	...
	public String saveCustomer(Customer customer, Model model, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "The custoemr ID "+ customer.getId()+" has been updated successfully!!");
		return "redirect:/customers";
	}
	...
	public String deleteCustomer(@PathVariable Integer id, RedirectAttributes ra){
		try {
			service.delete(id);
			ra.addFlashAttribute("message", "The custoemr ID "+ id+" has been deleted successfully!!");
		} catch (CustomerNotFoundException ex) {
			ra.addFlashAttribute("message",ex.getMessage());
		}
		return "redirect:/customers";
