...
public class CountryRepositoryTests {
	...
	public void testCreateCountry() {
		Country country = repo.save(new Country("United", "US"));
		Country country1 = repo.save(new Country("United", "UK"));
		Country country2 = repo.save(new Country("Bangladesh", "BD"));
	...
	public void testUpdateCountry() {
		...
		Country updateCountry = repo.findById(id).get();
		updateCountry.setName(name);
		
		Country updatedCountry = repo.save(updateCountry);
